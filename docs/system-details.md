...
Please refer to the [IPC](IPC.md) and [synchronization](synchronization.md) and [DLL Best Practices](dll_best_practices.md) documentation for more developer details on the system.
...
![graph](assets/performance_milestone2.png)
